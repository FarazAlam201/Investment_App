  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 63, top: 154),
            child: Image.asset(
          ...
          const Padding(
            padding: EdgeInsets.only(left: 41, right: 20, top: 18, bottom: 17),
            child: ShowText(
          ...
          const Padding(
            padding: EdgeInsets.only(left: 41, right: 20, bottom: 50),
            child: Text(
